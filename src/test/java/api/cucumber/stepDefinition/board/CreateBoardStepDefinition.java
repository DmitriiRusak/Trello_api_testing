...
//
//        configTestDataHolder.getBoardTestData().setToDoListId(
//                getBoardService().getListOfIdOfAllListsOnABoard(
//                        configTestDataHolder.getBoardTestData().getBoardId(),
//                        getBoardService().getBoardRequestSpecification()).
//                get(0).toString());
//        configTestDataHolder.getListTestData().setIdsOfAllListsPresentedOnABoard(getBoardService().getListOfIdOfAllListsOnABoard(configTestDataHolder.getBoardTestData().getBoardId(), getBoardService().getBoardRequestSpecification()));
//    }
//
