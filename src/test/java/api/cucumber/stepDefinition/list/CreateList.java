...
//        ArrayList list = (ArrayList) getListsService().getListOfIdOfAllListsOnABoard(configTestDataHolder.getBoardTestData().getBoardId(), getListsService().getListRequestSpecification());
