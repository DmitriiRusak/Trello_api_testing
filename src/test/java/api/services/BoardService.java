...
public class BoardService extends BaseService {
    ...
    public Response updateBoard(String boardId, String optionName, String optionValue) {
        requestSpecification.param(optionName, optionValue);
    ...
    public String getAllAvailableBoards() {
        ...
        Response response = apiClient.get(MEMBERS_BASE_PATH + MY_WORK_SPACE_ENDPOINT + BoardEndPoints.BOARDS_BASE_PATH, requestSpecification);
